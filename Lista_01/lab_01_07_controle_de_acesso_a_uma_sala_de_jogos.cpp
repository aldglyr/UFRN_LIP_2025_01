...
Você está desenvolvendo um sistema para controlar o acesso de usuários a uma sala de jogos de um clube. Para acessar a
sala, existem duas condições principais:
...
Seu objetivo é criar um programa que, dados a idade do usuário, o status de membro VIP e se ele está ou não banido,
determine se ele tem permissão para entrar na sala de jogos.
