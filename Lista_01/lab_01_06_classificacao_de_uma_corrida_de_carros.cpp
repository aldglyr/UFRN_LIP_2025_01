...
competição de corrida de carros. Cada competidor realiza uma volta no circuito, e você 
precisa determinar a classificação final com base no tempo gasto por cada piloto.

Seu programa deve:

1. Ler o tempo gasto por três competidores na corrida, onde cada tempo é um número real 
   (double) que representa o número de segundos;
2. Classificar os competidores do mais rápido (menor tempo) para o mais lento (maior 
   tempo);
...
Todas as saídas vem ter uma casa decimal de precisão. Utilize as bibliotecas e comandos 
abaixo para setar a precisão da saída:
