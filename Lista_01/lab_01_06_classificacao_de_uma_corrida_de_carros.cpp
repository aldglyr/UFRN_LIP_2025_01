/*
Você está desenvolvendo um sistema para registrar e classificar os tempos de uma competição de corrida de carros. Cada
competidor realiza uma volta no circuito, e você precisa determinar a classificação final com base no tempo gasto por
cada piloto.

Seu programa deve:

1. Ler o tempo gasto por três competidores na corrida, onde cada tempo é um número real (double) que representa o número
   de segundos;

2. Classificar os competidores do mais rápido (menor tempo) para o mais lento (maior tempo);
...
- A classificação dos três competidores do mais rápido para o mais lento no formato:

1° lugar: competidor X com Y segundos
2º lugar: competidor Z com W segundos
3º lugar: competidor Y com V segundos

Todas as saídas vêm ter uma casa decimal de precisão. Utilize as bibliotecas e comandos abaixo para setar a precisão da
saída:
