...
Você está desenvolvendo um sistema que compara valores inteiros de sensores em um experimento. A cada rodada, três
valores inteiros são coletados e você precisa determinar qual deles é o maior. Para simplificar essa tarefa, crie um
programa em C++ que receba três números inteiros e, utilizando uma função, retorne o maior dos três.
