...
valores inteiros. Em seguida, haverá uma linha contendo dois valores inteiros, 
Lb e Cb, correspondentes respectivamente ao número de linhas e número de colunas
da matriz B. As Lb linhas seguintes definem a matriz B, contendo, cada linha, Cb
valores inteiros.

A saída do seu programa deve ser a matriz La x Cb resultante da multiplicação de
A e B.
