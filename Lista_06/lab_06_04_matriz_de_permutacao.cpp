...
0’s e 1’s e se em cada linha e coluna da matriz existe um único valor 1. Escreva
um programa que verifica se uma dada matriz quadrada é de permutação ou não.
