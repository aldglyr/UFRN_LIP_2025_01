/*
    Você está desenvolvendo um sistema para registrar e classificar os tempos de uma competição de corrida de carros. Cada competidor realiza uma volta no circuito, e você precisa determinar a classificação final com base no tempo gasto por cada piloto.

    Seu programa deve:

    1. Ler o tempo gasto por três competidores na corrida, onde cada tempo é um número real (double) que representa o número de segundos;
    ...
    Todas as saídas vem ter uma casa decimal de precisão. Utilize as bibliotecas e comandos abaixo para setar a precisão da saída:
