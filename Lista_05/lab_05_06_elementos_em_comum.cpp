...
compara listas de números para encontrar elementos em comum. Sua tarefa é criar 
um programa que compare dois conjuntos de números e exiba os elementos que 
aparecem em ambos. Se não houver elementos em comum, o programa deverá exibir a 
mensagem "Nenhum".
