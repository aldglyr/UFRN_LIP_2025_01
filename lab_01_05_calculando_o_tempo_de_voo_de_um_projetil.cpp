/*
 *   magine que você está desenvolvendo um software para simular o movimento de projéteis em um jogo. Você precisa calcular o tempo em que o projétil atinge o solo, e isso pode ser representado por uma equação do segundo grau baseada na fórmula de movimento uniforme acelerado.
 *
 ...
 *
 *   Imprima todos os resultados com duas casas decimais de precisão. Utilize as bibliotecas e comandos abaixo para setar a precisão da saída:
 *
 *   #include<iomanip>
